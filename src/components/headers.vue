<template>
    <div class="headers">
        <div class="navfixed" ref="navfixed"
            :class="[$route.path == '/' || $route.path == '/aboutus' || $route.path == '/contactus' || $route.path == '/login' || $route.path == '/register' || $route.path =='/merchantApply' ? '' : 'fixed', sTop ?'fixing':'']">
            <div class="container top-bar clearfix">
                <router-link tag="i" to="/"
                    :class="$route.path == '/' || $route.path == '/aboutus' || $route.path == '/contactus' || $route.path == '/login' || $route.path == '/register' || $route.path =='/merchantApply' ? '' : 'picture'">
                </router-link>
